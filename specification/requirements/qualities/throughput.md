...
_State the minimum throughput the system MUST sustain under normal and peak load
conditions. Examples: The system MUST sustain at least 500 API requests per
second under normal load without exceeding the [latency](./latency.md)
