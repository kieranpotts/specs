...
- [**Overview**](./overview.md): The role of the SRS in the development lifecycle, why it is worth the effort, and how it compares to the alternative methods and tools.
...
- [**Definition of Ready**](./definition-of-ready.md): A useful set of criteria against which to judge a proposal for its readiness for being taken forward for approval and implementation.
